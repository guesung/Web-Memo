 ...
 *   node .github/scripts/measure-feature-usage.mjs [--from YYYY-MM-DD --to YYYY-MM-DD] [--format table|csv|json]
 *
...
import {
	...
	formatUsageJson,
	formatUsageTable,
} from "./lib/ga4-usage.mjs";
import { resolveTargetWeek } from "./lib/ga4-weekly.mjs";
...
const USAGE = `사용법: node .github/scripts/measure-feature-usage.mjs [옵션]
