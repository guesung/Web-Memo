 ...
 *   node .github/scripts/report-daily-ga.mjs
 */

import { buildDailyReportPayload } from "./lib/daily-report-blocks.mjs";
import { fetchDailyGa4Report } from "./lib/ga4-data.mjs";
