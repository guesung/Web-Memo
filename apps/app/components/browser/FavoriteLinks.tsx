  ...
  if (!favorites || favorites.length === 0) {
    return (
      <View className="mt-7 px-5">
        <Text className="text-base font-bold text-foreground mb-3">즐겨찾기</Text>
  ...
  return (
    <View className="mt-7">
      ...
      <FlatList
        ...
        renderItem={({ item }) => <FavoriteItem item={item} onPress={onSelectUrl} onLongPress={handleLongPress} />}
      />
    </View>
  );
}
