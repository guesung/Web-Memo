...
export const COMPARE_PAGE_COPY = {
	hero: {
		...
		descriptions: [
			"웹 메모, 노션 웹 클리퍼, 라이너, Glasp, Google Keep 확장까지 크롬에서 메모·하이라이트에 쓸 수 있는 확장 다섯 개를 나란히 놓았어요.",
	...
	comparison: {
		title: "기준별 비교",
		caption:
			"각 제품 공식 페이지를 기준으로 정리했어요. 공식 안내만으로 판단할 수 없는 항목은 ‘확인 못 함’으로 표시했으며, 기능이 없다는 뜻은 아니에요. 확인 날짜는 아래 출처에 있어요.",
		loginNote:
