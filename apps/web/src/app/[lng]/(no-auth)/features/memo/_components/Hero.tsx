				...
				<div className="text-center">
					<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 mb-6">
						...
						<span className="text-sm font-medium">
							{t("features.memo.hero.badge")}
						</span>
					</div>

					<h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
						{t("features.memo.hero.title")}
						<span className="block text-blue-500 mt-2">
							{t("features.memo.hero.titleHighlight")}
						</span>
					</h1>

					<p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
						{t("features.memo.hero.description")}
					</p>
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						...
						>
							{t("features.memo.hero.learnMore")}
						</Link>
					</div>
				</div>
			</div>
