...
const FAQ_DATA = {
	ko: {
		what_is: {
			question: "웹 메모가 뭔가요?",
			answer: `웹 메모는 간편 메모 및 요약 서비스입니다. 아티클을 읽거나, 유튜브 영상을 볼 때 '이거 한 줄로 누가 요약해주면 좋겠다..'싶으신 적 있으신가요? 그런 고민을 한 당신을 위해서 준비했습니다. 아티클을 읽으면서 단축키 하나로 사이드 패널을 여세요. 자동으로 아티클 혹은 유튜브 영상을 AI가 요약해줍니다. 그리고 메모를 작성하세요. 작성된 메모는 ${CONFIG.webDisplayHost}에서 언제든지 확인할 수 있어요.`,
		},
		is_free: {
			question: "서비스는 무료인가요?",
