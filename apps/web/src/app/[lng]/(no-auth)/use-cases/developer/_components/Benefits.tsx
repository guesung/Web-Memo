...
export default function Benefits({ lng }: BenefitsProps) {
	...
	const benefits = [
		{
			icon: Code,
			title: t("useCases.developer.benefits.snippet.title"),
			description: t("useCases.developer.benefits.snippet.description"),
			iconBg: "bg-emerald-500/10",
			iconColor: "text-emerald-500",
		},
		{
			icon: BookOpen,
			title: t("useCases.developer.benefits.blog.title"),
			description: t("useCases.developer.benefits.blog.description"),
			iconBg: "bg-teal-500/10",
			iconColor: "text-teal-500",
		},
		{
			icon: GitBranch,
			title: t("useCases.developer.benefits.github.title"),
			description: t("useCases.developer.benefits.github.description"),
			iconBg: "bg-green-500/10",
			iconColor: "text-green-500",
		},
		{
			icon: FileText,
			title: t("useCases.developer.benefits.docs.title"),
			description: t("useCases.developer.benefits.docs.description"),
